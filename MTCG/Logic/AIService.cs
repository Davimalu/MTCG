...
namespace MTCG.Logic
{
    public class AIService : IAIService
    {
        ...
        public string? GetListOfCards(string theme, string apiKey)
        {
            ...
            {
                _eventService.LogEvent(EventType.Error, "Couldn't generate cards: OpenAI API Error", ex);
                return null;
            }
        }
    }
